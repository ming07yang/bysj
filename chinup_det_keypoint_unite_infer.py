...
if __name__ == '__main__':
    ...
    #                     default='D:/0code_python/PaddleDetection-release-2.6/output_inference/picodet_v2_s_320_pedestrian',
    #                     help="det model")
    # parser.add_argument('--keypoint_model_dir', type=str,
    #                     default='D:/0code_python/PaddleDetection-release-2.6/output_inference/tinypose_128x96',
    #                     help="keypoint model")
