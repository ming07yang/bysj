...
def argsparser():
    ...
    parser.add_argument(  #物体检测模型
        "--det_model_dir",
        type=str,
        default="D:/ChinUp/output_inference/picodet_v2_s_192_pedestrian",
        # default=None,
        help=("Directory include:'model.pdiparams', 'model.pdmodel', "
              "'infer_cfg.yml', created by tools/export_model.py."),
        required=False)
    parser.add_argument(
        "--keypoint_model_dir", #关键点检测模型
        type=str,
        default="D:/ChinUp/output_inference/tinypose_128x96",
        # default=None,
        help=("Directory include:'model.pdiparams', 'model.pdmodel', "
              "'infer_cfg.yml', created by tools/export_model.py."),
        required=False)
    ...
    parser.add_argument(
        "--video_file",  #检测视频
        type=str,
        default="D:/ChinUp/output_inference/chinup.mp4",
        # default=None,
    ...
    parser.add_argument(
        '--filter_type',   #使用平滑算法  oneeuro/EMA
        type=str,
        default='OneEuro',
